@extends('layouts.app')
@section('title', 'Pending Authorizations')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 text-black">Pending Authorizations</h1>
</div>
...
@if($requests->isEmpty())
    <div class="alert alert-secondary">No pending authorizations.</div>
@else
        ...
        <tbody>
            @foreach($requests as $request)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('authorizations.authorize', $request) }}" class="d-flex flex-column gap-2">
                            @csrf
